...
**E3 ★★★** Baue einen Einzeiler, der die IP-Adresse deines Default-Gateways ausgibt — nur mit `ip` und `awk`. Dann erweitere ihn: zeige die MAC-Adresse des Gateways.

- [ ] Funktionieren beide Einzeiler? Das sind typische Scripting-Patterns im RZ.

---

**E4 ★★★** Kombiniere alles: erstelle einen Mini-Netzwerk-Report mit einem einzigen Befehl der Interfaces, IPs, Default Route, Gateway MAC und DNS anzeigt.
